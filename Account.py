...
path1 = r'C:\Users\tanyi\Downloads\储蓄卡账单.txt'                          #建设银行储蓄卡账单路径（txt文件）
path2 = r'C:\Users\tanyi\Downloads\信用卡账单.csv'                          #建设银行信用卡账单路径（csv文件）
path3 = r'D:\Python\Financial\Data\微信支付账单(20220921-20221209).csv'     #微信账单（csv文件）
path4 = r''                                                                 #支付宝账单（csv文件）
...
def read_data_ccb2(path):  # 获取建设银行储蓄卡数据,并调整数据格式
...
data_merge = pd.concat([data_ccb1,data_ccb2,data_wx1])
print(data_merge)
